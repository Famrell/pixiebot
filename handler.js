...
export async function participantsUpdate({ id, participants, action }) {
    ...
    this.sendHydrated(id, text, wm + '\n\n' + botdate, pp, sgc, (action == 'add' ? 'Welcome' : 'Bye'), user.split`@`[0], '🌹 USER', [
      ['ᴍᴇɴᴜ', '/menu'],
      [(action == 'add' ? '\n\nHalo New Member Silahkan Baca Deskripsi Grub Dan Silahkan Dipatuhi ya(' : '\n\nSemoga Rezekinya dilancarkan! :)'), '...'],
      [null, null]
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: '*Developer Only* • Command ini hanya untuk developer',
        ...
        group: '*Only Chat Grub* • Command ini hanya bisa digunakan di grub chat',
        private: '*Only Private Chat* • Command ini hanya bisa digunakan di private chat',
        admin: '*Only Admin* • Command ini hanya untuk admin grub',
        botAdmin: '*Bot Admin Only* • Command ini hanya bisa digunakan saat bot menjadi admin',
        restrict: '*Restrict* • ʀᴇsᴛʀɪᴄᴛ ʙᴇʟᴜᴍ ᴅɪɴʏᴀʟᴀᴋᴀɴ ᴅɪᴄʜᴀᴛ ɪɴɪ',
    }[type]
    ...
    let msgg = {
    	unreg: 'Hallo PixiPedia ! 👋\nAnda Belum Terdaftar Di Database Bot Silahkan Mendaftar\n\n➞ Klik Tombol Dibawah Untuk Mendaftar Kedalam Database Bot'
}[type]
